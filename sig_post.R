...
BRD <- readOGR("./data/shapefile/Bacia_Doce/Bacia_Doce.shp")

################## List and stack Projections of ensemble raw mean 

############
Present_ <- list.files("./Results_ens_mean/Results_ensemble_present/Continuo_1",pattern = "tif", full.name = TRUE)

Present <- stack(Present_)

############

rcp45_CanESM2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_CanESM2/Continuo_1",pattern = "tif", full.name = TRUE)

rcp45_CanESM2 <- stack(rcp45_CanESM2_)

############

rcp45_HadGEM2_ <- list.files("./Results_ens/Results_ensemble_rcp45_HadGEM2/CONTI_MEAN_MEAN",pattern = "tif", full.name = TRUE)

rcp45_HadGEM2 <- stack(rcp45_HadGEM2_)

############

rcp45_MIROC_ <- list.files("./Results_ens/Results_ensemble_rcp45_MIROC/CONTI_MEAN_MEAN",pattern = "tif", full.name = TRUE)

rcp45_MIROC <- stack(rcp45_MIROC_)

############

rcp85_CanESM2_ <- list.files("./Results_ens/Results_ensemble_rcp85_CanESM2/CONTI_MEAN_MEAN",pattern = "tif", full.name = TRUE)

rcp85_CanESM2 <- stack(rcp85_CanESM2_)

############

rcp85_HadGEM2_ <- list.files("./Results_ens/Results_ensemble_rcp85_HadGEM2/CONTI_MEAN_MEAN",pattern = "tif", full.name = TRUE)
rcp85_HadGEM2 <- stack(rcp85_HadGEM2_)

############

rcp85_MIROC_ <- list.files("./Results_ens/Results_ensemble_rcp85_MIROC/CONTI_MEAN_MEAN",pattern = "tif", full.name = TRUE)
...
Present_NEW_CONT_ <- list.files("./Results_ens/Results_ensemble_present/New_CONT",pattern = "tif", full.name = TRUE) 
...
############
Present_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_present/Continuo_1",pattern = "tif",full.name = TRUE)
...
Present_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_present/Continuo_2",pattern = "tif",full.name = TRUE)
...
Present_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_present/Binario_1",pattern = "tif",full.name = TRUE)
...
Present_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_present/Binario_2",pattern = "tif",full.name = TRUE)
...
rcp45_CanESM2_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp45_CanESM2/Continuo_2",pattern = "tif", full.name = TRUE) 
...
rcp45_CanESM2_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_CanESM2/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp45_CanESM2_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_CanESM2/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp45_CanESM2_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_CanESM2/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp45_CanESM2_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_CanESM2/Binario_2",pattern = "tif",full.name = TRUE)
...
# Segundo treshold a partir do novo contínuo
rcp45_HadGEM2_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp45_HadGEM2/Continuo_2",pattern = "tif", full.name = TRUE) 
...
rcp45_HadGEM2_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_HadGEM2/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp45_HadGEM2_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_HadGEM2/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp45_HadGEM2_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_HadGEM2/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp45_HadGEM2_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_HadGEM2/Binario_2",pattern = "tif",full.name = TRUE)
...
# Segundo treshold a partir do novo contínuo
rcp45_MIROC_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp45_MIROC/Continuo_2",pattern = "tif",  full.name = TRUE) 
...
rcp45_MIROC_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_MIROC/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp45_MIROC_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_MIROC/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp45_MIROC_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_MIROC/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp45_MIROC_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp45_MIROC/Binario_2",pattern = "tif",full.name = TRUE)
...
#### Segundo treshold a partir do novo contínuo
rcp85_CanESM2_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp85_CanESM2/Continuo_2",pattern = "tif", full.name = TRUE) 
...
rcp85_CanESM2_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_CanESM2/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp85_CanESM2_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_CanESM2/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp85_CanESM2_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_CanESM2/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp85_CanESM2_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_CanESM2/Binario_2",pattern = "tif",full.name = TRUE)
...
# Segundo treshold a partir do novo contínuo
rcp85_HadGEM2_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp85_HadGEM2/Continuo_2",pattern = "tif",
                                      full.name = TRUE) 
...
rcp85_HadGEM2_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_HadGEM2/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp85_HadGEM2_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_HadGEM2/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp85_HadGEM2_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_HadGEM2/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp85_HadGEM2_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_HadGEM2/Binario_2",pattern = "tif",full.name = TRUE)
...
# Segundo treshold a partir do novo contínuo
rcp85_MIROC_CONT_new_ <- list.files("./Results_ens/Results_ensemble_rcp85_MIROC/Continuo_2",pattern = "tif", full.name = TRUE) 
...
rcp85_MIROC_continuo1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_MIROC/Continuo_1",pattern = "tif", full.name = TRUE)
...
rcp85_MIROC_continuous2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_MIROC/Continuo_2",pattern = "tif",full.name = TRUE)
...
rcp85_MIROC_bin1_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_MIROC/Binario_1",pattern = "tif",full.name = TRUE)
...
rcp85_MIROC_bin2_ <- list.files("./Results_ens_mean/Results_ensemble_rcp85_MIROC/Binario_2",pattern = "tif",full.name = TRUE)
